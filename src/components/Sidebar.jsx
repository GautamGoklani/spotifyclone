...
// Define a Spotify logo SVG component
const SpotifySVG = () => (
...
const Sidebar = ({ view, setView, setGlobalPlaylistId }) => {
    ...
    useEffect(() => {
        async function fetchPlaylists() {
            try {
                // Send a request to Spotify API to retrieve user's playlists
        ...
        // Call the fetchPlaylists function when the token changes
        fetchPlaylists();
    }, [token]);
