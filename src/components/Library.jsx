...
const Library = ({ setView, setGlobalPlaylistId }) => {
    ...
    // Use useEffect to fetch user's playlists when the token changes
    useEffect(() => {
        async function fetchData() {
            ...
            setPlaylists(data.items); // Update the playlists state with fetched data
        }
        fetchData();
    ...
    return (
        <div className='flex-grow h-screen'>
            ...
            <div className='flex flex-col gap-4 px-8 h-screen overflow-y-scroll'>
                <h2 className='text-xl font-bold'>Playlists</h2> {/* Heading for playlists section */}
                <div className='flex flex-wrap gap-6 mb-48'>
                    {/* Map through and render user's playlists */}
